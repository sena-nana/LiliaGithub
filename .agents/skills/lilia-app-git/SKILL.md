---
name: lilia-app-git
description: Git workflow for LiliaGithub changes. Use when Codex stages, commits, pushes, merges, syncs dependencies, reviews diffs before committing, or needs to preserve user and other-agent changes in this repository.
---
