...
description: Validation strategy for LiliaGithub changes. Use when Codex needs to choose or report checks after app code, routes, commands, UI, Tauri Rust, dependencies, build config, documentation, tests, or LiliaUI dependency updates change.
---
