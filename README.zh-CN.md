...
- [ ] GitHub 仓库元信息、star、fork、release 和默认分支状态。
- [ ] issue、pull request、review 和 discussion 浏览。
- [ ] 仓库和个人维度的 GitHub Projects 看板查看。
- [ ] 通知收件箱，支持按仓库、issue、pull request 和 review 过滤。
- [ ] 最近推送活动、Actions 结果、release 状态和失败 workflow 查看。
