...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::workspace_pick_repo,
            workspace::workspace_refresh_repos,
            workspace::workspace_list_managed_repos,
            workspace::workspace_scan_repos,
            workspace::workspace_discover_repos,
            workspace::workspace_add_repo,
            workspace::workspace_clone_repo,
            workspace::workspace_hide_repo,
            workspace::workspace_remember_remote_repo,
            workspace::workspace_forget_remote_repo,
            workspace::workspace_unhide_repo,
            workspace::workspace_list_hidden_repos,
            workspace::workspace_list_tasks,
            workspace::workspace_cancel_task,
            ...
            workspace::github_update_issue,
            workspace::github_list_workflow_runs,
            workspace::repo_get_summary,
            workspace::repo_refresh_summary,
