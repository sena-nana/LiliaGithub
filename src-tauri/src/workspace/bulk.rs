...
delegate_command!(async bulk; fn bulk_sync_execute(app: AppHandle, operation: String, repo_ids: Vec<String>, local_changes_mode: Option<RepoPullLocalChangesMode>,) -> Result<Vec<BulkSyncResult>, String>);
