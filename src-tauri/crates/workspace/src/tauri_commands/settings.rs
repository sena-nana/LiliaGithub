...
delegate_command!(async settings; fn workspace_move_repo_to_group(app: AppHandle, repo_id: String, group_id: Option<String>, path_mode: Option<WorkspaceRepoPathMode>,) -> Result<WorkspaceRepoRelocationResult, String>);
