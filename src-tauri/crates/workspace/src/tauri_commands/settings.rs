...
delegate_command!(settings; fn workspace_pick_repo(app: AppHandle) -> Result<Option<String>, String>);
delegate_command!(settings; fn workspace_pick_files(app: AppHandle) -> Result<Vec<String>, String>);
