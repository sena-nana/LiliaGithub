...
import { repoIncludedInHomeCodeStats } from "../config/repoSettingsManifest";
...
function applyGitHubRepoPage(
  ...
  githubRepos.value = append && !refresh ? dedupeGitHubRepos([...githubRepos.value, ...page.items]) : page.items;
